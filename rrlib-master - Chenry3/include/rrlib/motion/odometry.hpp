...
class TwoWheelOdometryPros : public PoseEstimator {
    pros::Mutex lock;
    Pose currentPose;
    std::shared_ptr<pros::Rotation> LeftRot;
    std::shared_ptr<pros::Rotation> rightRot;
    okapi::ChassisScales scales;
...
public:
    TwoWheelOdometryPros(
        std::shared_ptr<pros::Rotation> leftEnc,
        std::shared_ptr<pros::Rotation> rightEnc,
        okapi::ChassisScales scales);
